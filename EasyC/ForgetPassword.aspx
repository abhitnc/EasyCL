                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic" runat="server" ControlToValidate="email" ErrorMessage="Email Required"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="text-center">
                                        <asp:Button ID="submit" OnClick="SendEmail" runat="server" Text="Get Password" CssClass="btn btn-primary mt-4"/>
                                    </div>
                                    <div class="text-muted font-italic">
                                        <small>
                                            <span class="text-success font-weight-700"><asp:Label ID="lblMessage" runat="server" /></span>
                                        </small>
                                    </div>
