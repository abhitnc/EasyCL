                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                            ...
                            <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <form runat="server">
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator runat="server" Display="Dynamic"  ID="RegularExpressionValidator1" ErrorMessage="Wrong email address" ControlToValidate="email" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" Display="Dynamic" runat="server" ControlToValidate="pass" ErrorMessage="Password Required"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="text-center">
                                        <asp:Button ID="submit" OnClick="submit_Click" runat="server" Text="Login" CssClass="btn btn-primary mt-4"/>
                                    </div>
                                </form>
                            </div>
                        </div>
